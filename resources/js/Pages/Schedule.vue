...
const showModalScheduleNew = (schedule = null) => {
    ...
    if (schedule) {
        ...
        formScheduleNew.numOfClassPeriodsPerDay =
            schedule.numOfClassPeriodsPerDay;
        for (let index in schedule.timeOfEachClassPeriod) {
            timeOfEachClassPeriodSFN.value[index] =
                schedule.timeOfEachClassPeriod[index].start;
            timeOfEachClassPeriodEFN.value[index] =
                schedule.timeOfEachClassPeriod[index].end;
        }
    }
...
const showModalScheduleEdit = () => {
    ...
    formScheduleEdit.numOfClassPeriodsPerDay =
        usePage().props.schedule_selected.numOfClassPeriodsPerDay + "";
    for (let index in usePage().props.schedule_selected.timeOfEachClassPeriod) {
        timeOfEachClassPeriodSFE.value[index] =
            usePage().props.schedule_selected.timeOfEachClassPeriod[
                index
            ].start;
        timeOfEachClassPeriodEFE.value[index] =
            usePage().props.schedule_selected.timeOfEachClassPeriod[index].end;
    }
...
const submitScheduleEdit = () => {
    ...
    formScheduleEdit.patch(
        route("schedule.update", usePage().props.schedule_selected),
        {
...
const submitScheduleDelete = () => {
    router.delete(
        route("schedule.destroy", usePage().props.schedule_selected),
        {
...
const submitDetailNew = () => {
    formDetailNew.post(
        route("schedule.detail.store", [usePage().props.schedule_selected]),
        {
...
const submitDetailEdit = () => {
    formDetailEdit.patch(
        route("schedule.detail.update", [
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            >
                <span class="mr-auto">
                    Schedules
                    <span v-if="schedule_selected">
                        / {{ schedule_selected.name }}
                    </span>
                </span>
            ...
            >
                ...
                <PrimaryButton @click="showModalScheduleNew()"
        ...
        <div class="py-12" v-if="schedules.length > 0">
            <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-wrap justify-end items-center space-x-2">
                    <Dropdown align="right" class="mb-2">
                        <template #trigger>
                            <span class="inline-flex rounded-md">
                                <PrimaryButton>
                    ...
                    >
                        ...
                        >
                            <li
                                v-if="
                                    link.active ||
                                    (schedule_details.current_page == 1 &&
                                        index == 3) ||
                                    (schedule_details.current_page ==
                                        schedule_details.last_page &&
                                        index ==
                                            schedule_details.links.length -
                                                4) ||
                                    (!link.active &&
                                        link.label != '...' &&
                                        (index == 0 ||
                                            index ==
                                                schedule_details.links.length -
                                                    1 ||
                                            link.url ==
                                                schedule_details.next_page_url ||
                                            link.url ==
                                                schedule_details.prev_page_url))
                                "
                            >
                                <Link
                                    :href="link.url"
                                    ...
                                    :class="{
                                        ...
                                        'rounded-r-lg':
                                            index ==
                                            schedule_details.links.length - 1,
                                    }"
                                    :only="[
                                        'schedule_details',
                                        'sort',
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-gray-700 text-white">
                                ...
                                <th
                                    class="px-3 md:px-6 py-3 whitespace-nowrap text-left"
                                >
                                    <Link
                                        :href="
                                            route('schedule.show', {
                                ...
                                <th
                                    class="px-3 md:px-6 py-3 whitespace-nowrap text-right w-auto"
                                >
                                    <Link
                                        :href="
                                            route('schedule.show', {
                                ...
                                <th
                                    class="px-3 md:px-6 py-3 whitespace-nowrap w-auto"
                                >
                                    <Link
                                        class="flex items-center space-x-1 justify-center"
                                        replace
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td
                                    class="px-3 md:px-6 py-3 whitespace-nowrap w-full flex items-center"
                                >
                                    <svg
                                        class="mr-2"
                                        height="1.5em"
                                ...
                                >
                                    {{
                                        timeOfEachClassPeriod[schedule.start]
                                            .start
                                    }}
                                </td>
                                <td
                                ...
                                <td
                                    class="px-3 md:px-6 py-3 whitespace-nowrap text-center w-auto"
                                >
                                    {{ schedule.type }}
                                </td>
                                <td
                                ...
                                <td
                                    class="px-3 md:px-6 py-1 whitespace-nowrap text-center space-x-2"
                                >
                                    <SecondaryButton
                                        type="button"
                ...
                <div class="mt-2" v-if="schedule_details.last_page > 1">
                    <ul
                        class="flex justify-end items-center -space-x-px h-[2.5rem] text-sm"
                    >
                        <template
                            v-for="(link, index) in schedule_details.links"
                            :key="index"
        ...
        <Modal :show="isShowModalScheduleNew" @close="closeModalScheduleNew">
                ...
                >
                    ...
                    <div>
                        ...
                        <InputError
                            class="mt-2"
                            :message="
                                formScheduleNew.errors.numOfClassPeriodsPerDay
                            "
                        />
                    </div>
                    <div
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <InputLabel value="Start" :for="`start-${i}`" />
                                <TextInput
                                    class="mt-1 block w-full"
                                    required
                                    type="time"
                                ...
                                <InputError
                                    class="mt-2"
                                    :message="
                                        formScheduleNew.errors[
                                            `timeOfEachClassPeriod.${i}.start`
                                        ]
                                    "
                                />
                            </div>
                            <div>
                                <InputLabel value="End" :for="`end-${i}`" />
                                <TextInput
                                    class="mt-1 block w-full"
                                    required
                                    type="time"
            ...
            >
                <SecondaryButton type="button" @click="closeModalScheduleNew"
                    >Close</SecondaryButton
                >
                <PrimaryButton form="form-schedule-new" type="submit"
                    >Add</PrimaryButton
                >
            </div>
        </Modal>
        ...
        <Modal :show="isShowModalScheduleEdit" @close="closeModalScheduleEdit">
                ...
                >
                    ...
                    <div>
                        ...
                        <InputError
                            class="mt-2"
                            :message="
                                formScheduleEdit.errors.numOfClassPeriodsPerDay
                            "
                        />
                    </div>
                    <div
                        v-for="i in formScheduleEdit.numOfClassPeriodsPerDay *
                        1"
                        :key="i"
                    >
                        <InputLabel>
            ...
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <SecondaryButton type="button" @click="closeModalScheduleEdit"
                    >Close</SecondaryButton
                >
                <PrimaryButton form="form-schedule-edit" type="submit"
        ...
        >
            ...
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <PrimaryButton type="button" @click="closeModalScheduleDelete"
                    >No</PrimaryButton
                >
                <DangerButton type="button" @click="submitScheduleDelete"
                    >Yes</DangerButton
                >
            </div>
        </Modal>
        ...
        >
            ...
            <div class="p-6">
                <div v-if="schedule_share">
                    ...
                    <p>
                        Everyone can visit the below link and see it (they can't
                        edit it)
                    </p>
                    <a
                        :href="route('share', [schedule_share])"
                        target="_blank"
                        class="font-mono p-1 rounded bg-gray-300"
                        >{{ route("share", [schedule_share]) }}</a
                    >
            ...
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <SecondaryButton type="button" @click="closeModalScheduleShare"
                    >Close</SecondaryButton
                >
                <PrimaryButton
                    type="button"
                ...
                >
                <PrimaryButton type="button" @click="submitScheduleShare" v-else
                    >Share</PrimaryButton
                >
            </div>
        </Modal>
        ...
        <Modal :show="isShowModalDetailNew" @close="closeModalDetailNew">
            <div
                class="flex items-start justify-between p-4 border-b rounded-t"
            >
                <h3 class="text-xl font-semibold text-gray-900">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            ...
                            >
                                ...
                                >
                                    {{ index }}.
                                    {{ timeOfEachClassPeriod[index].start }} -
                        ...
                        <div>
                            ...
                            >
                                <option
                                    v-for="index in (numOfClassPeriodsPerDay -
                                        formDetailNew.start +
                                        1) *
                                    1"
                    ...
                    <div>
                        ...
                        <InputError
                            ...
                            v-for="key in Object.keys(
                                formDetailNew.errors
                            ).filter((v) => v.indexOf('dateOfWeek.') > -1)"
                            :key="key"
            ...
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <SecondaryButton type="button" @click="closeModalDetailNew"
                    >Close</SecondaryButton
                >
                <PrimaryButton form="form-new" type="submit">Add</PrimaryButton>
            </div>
        </Modal>

        <!-- Editing Detail Modal -->
        <Modal :show="isShowModalDetailEdit" @close="closeModalDetailEdit">
            <div
                class="flex items-start justify-between p-4 border-b rounded-t"
            >
                <h3 class="text-xl font-semibold text-gray-900">
            ...
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <SecondaryButton @click="closeModalDetailEdit" type="button"
                    >Close</SecondaryButton
                >
                <PrimaryButton form="form-edit" type="submit"
                    >Update</PrimaryButton
                >
            </div>
        </Modal>
        ...
        <Modal :show="isShowModalDetailDelete" @close="closeModalDetailDelete">
            <div
                class="flex items-start justify-between p-4 border-b rounded-t"
            >
                <h3 class="text-xl font-semibold text-gray-900">
            ...
            <div class="p-6">
                ...
                <b
                    >"{{
                        deleteDetail &&
                        subjects.find(
                            (v) => v.subject_id == deleteDetail.subject_id
                        )?.name
                    }}" ({{ deleteDetail && deleteDetail.from }} -
                    {{ deleteDetail && deleteDetail.to }})</b
                >?
            </div>
            <div
                class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b"
            >
                <PrimaryButton type="button" @click="closeModalDetailDelete"
                    >No</PrimaryButton
                >
                <DangerButton type="button" @click="submitDetailDelete"
                    >Yes</DangerButton
                >
            </div>
        </Modal>
