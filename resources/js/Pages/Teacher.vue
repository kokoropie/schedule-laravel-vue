                        ...
                        <thead>
                            <tr class="bg-gray-700 text-white">
                                <th class="px-3 py-3 whitespace-nowrap w-auto">
                                    ...
                                    })" preserve-scroll class="flex items-center space-x-1 justify-center" :only="['teachers', 'sort', 'sort_by']">
                                        <span>#</span>
                                ...
                                <th class="px-3 md:px-6 py-3 whitespace-nowrap text-left">
                                    <Link :href="route('teacher.index', {
                                        ...
                                        sort_by: 'name'
                                    })" preserve-scroll class="flex items-center space-x-1" :only="['teachers', 'sort', 'sort_by']">
                                        <span>Name</span>
